...
namespace mCoreDemo
{
    public partial class frmMain : Form
    {
        ...
        private void objSMS_NewMessageReceived(object sender, mCore.NewMessageReceivedEventArgs e)
        {
            ...
            if (e.TextMessage[0].ToString() == "N")
            {
            lat = (e.TextMessage).Substring(0, 8);
            lon=(e.TextMessage).Substring(9, 7);
            }
            else{
                lat = "NAN";
                lon = "NAN";
            ...
            if (lat == "NAN")
                MessageBox.Show("There are some internal problems.../n"+"Please,restart the program.");
